                              ...
                              <div className="right-container">
                               ...
                               <form>
                                ...
                                <div className="social-login">
                                    <button className="social-google"> <img src={google} alt="My google" className="my-google"/>Google</button>
                                    <button className="social-facebook"> <img src={facebook} alt="My google" className="my-google"/>Facebook</button>
                                </div>

                                <div className="divider"> or login with
                                </div>
                                 ...
                                 {/* <div className="row">
                                  ...
                                  <p>Agree with <a href="">Terms & Conditions</a>  and <a href="">Privacy Policy</a>.    </p>
